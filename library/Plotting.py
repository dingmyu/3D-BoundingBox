...
def constraint_to_color(constraint_idx):
    return {
        0 : cv_colors.PURPLE, #left
        1 : cv_colors.ORANGE, #top
        2 : cv_colors.MINT, #right
        3 : cv_colors.YELLOW #bottom
    }[constraint_idx]
...
def plot_3d_box(img, cam_to_img, ry, dimension, center):
    ...
    #TODO put into loop
    cv2.line(img, (box_3d[0][0], box_3d[0][1]), (box_3d[2][0],box_3d[2][1]), cv_colors.GREEN, 1)
    cv2.line(img, (box_3d[4][0], box_3d[4][1]), (box_3d[6][0],box_3d[6][1]), cv_colors.GREEN, 1)
    cv2.line(img, (box_3d[0][0], box_3d[0][1]), (box_3d[4][0],box_3d[4][1]), cv_colors.GREEN, 1)
    cv2.line(img, (box_3d[2][0], box_3d[2][1]), (box_3d[6][0],box_3d[6][1]), cv_colors.GREEN, 1)

    cv2.line(img, (box_3d[1][0], box_3d[1][1]), (box_3d[3][0],box_3d[3][1]), cv_colors.GREEN, 1)
    cv2.line(img, (box_3d[1][0], box_3d[1][1]), (box_3d[5][0],box_3d[5][1]), cv_colors.GREEN, 1)
    cv2.line(img, (box_3d[7][0], box_3d[7][1]), (box_3d[3][0],box_3d[3][1]), cv_colors.GREEN, 1)
    cv2.line(img, (box_3d[7][0], box_3d[7][1]), (box_3d[5][0],box_3d[5][1]), cv_colors.GREEN, 1)

    for i in range(0,7,2):
        cv2.line(img, (box_3d[i][0], box_3d[i][1]), (box_3d[i+1][0],box_3d[i+1][1]), cv_colors.GREEN, 1)

    front_mark = [(box_3d[i][0], box_3d[i][1]) for i in range(4)]

    cv2.line(img, front_mark[0], front_mark[3], cv_colors.BLUE, 1)
    cv2.line(img, front_mark[1], front_mark[2], cv_colors.BLUE, 1)
...
def plot_2d_box(img, box_2d):
    ...
    # plot the 2d box
    cv2.line(img, pt1, pt2, cv_colors.BLUE, 2)
    cv2.line(img, pt2, pt3, cv_colors.BLUE, 2)
    cv2.line(img, pt3, pt4, cv_colors.BLUE, 2)
    cv2.line(img, pt4, pt1, cv_colors.BLUE, 2)
