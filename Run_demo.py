    ...
    for id in ids:
        ...
        for detection in detections:
            ...
            if FLAGS.show_yolo:
                ...
                print(detected_class, -1, -1, alpha, box_2d[0][0],box_2d[0][1],box_2d[1][0],box_2d[1][1], dim[0], dim[1], dim[2], location[0], location[1], location[2], theta_ray+alpha, detection.confidence, file = f)
            else:
